#mineração de regras usando o eclat / usando arquivos do github. o eclat minera apenas a frequência da ocorrência
#dos itens nas transações ele é um associador mais simples. ele vai mostra qual a frequência dos itens na transações
import os;
import sys;
import numpy as np;
...
#EXECUCAO DE FATO DO METO A CIMA E SO A BIBLIOTECA DO GITHUB

# Geração dos itens frequentes
if	__name__== "__main__":
	main("C:/Users/Cliente/Desktop/Python/UDEMY/Machine_learning/transacoes2.txt", 3);
